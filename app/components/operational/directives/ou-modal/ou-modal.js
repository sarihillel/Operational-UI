'use strict';
var directive = function ($modal, $log, $filter) {
    'ngInject'
    var idModal = 0;
    ...
    var directive = {
        ...
        templateUrl: './components/operational/directives/ou-modal/ou-modal.html',
        link: linkFunc
    };
        ...
        *****************************************************/
        ...
        scope.open = function (size) {
            ...
            var modalInstance = $modal.open({
                ...
                templateUrl: 'ou-modal-template.html',
                windowClass: 'ou-modal-window',
                size: 'lg',
                resolve: {
                    data: function () {
                        return {
