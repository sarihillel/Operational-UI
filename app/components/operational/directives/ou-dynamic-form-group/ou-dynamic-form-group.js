 ...
 *      var groups = [{
    ...
    use:
    <ou-dynamic-form-group groups='groups'></ou-dynamic-form-group>
 */
var directive = function (INPUT_TYPES, $filter) {
    'ngInject'
    ...
    var directive = {
        ...
        templateUrl: './components/operational/directives/ou-dynamic-form-group/ou-dynamic-form-group.html',
        link: linkFunc
    };
